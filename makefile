...
MINGW_DEBUG_COMPILE_OPTIONS= -g -O0 -ggdb -DDEBUG_BUILD -fsanitize=address -fsanitize=leak
MSVC_DEBUG_COMPILE_OPTIONS= /Od /Z7 /DDEBUG_BUILD /fsanitize=address /MTd
